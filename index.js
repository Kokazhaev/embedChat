function setDocument() {
  ...
  var chat_logo = document.createElement('img');
  chat_logo.id = 'chat_logo';
  chat_logo.src = './logo.png';
  ...
  function openChatChoose() {
    ...
    if(chatStatus) {
      ...
      chat_logo.style.display = buttonStatus ? 'block' : 'none';
    }
  }
